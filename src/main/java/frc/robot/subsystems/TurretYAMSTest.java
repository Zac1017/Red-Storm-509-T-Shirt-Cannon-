...
public class TurretYAMSTest extends SubsystemBase {
    ...
    private final NetworkTableEntry turretAngle = turretTable.getEntry("angle");
    ...
    public Double convertAngleToDouble() {
        return Double.valueOf(((getAngle()).toString()));
    }

    @Override
    public void periodic() {
        turretAngle.getDouble(convertAngleToDouble());
